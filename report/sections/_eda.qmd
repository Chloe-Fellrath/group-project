...
```{python}
#| eval: false
#| label: fig-release-year-decades
...
![Gender distribution across decades](report/images/fig-gender-decade.png){#fig-gender-decade}
```{python}
#| eval: false
...
![Gender representation across top 10 genres](report/images/fig-gender-top-genres.png){#fig-gender-top-genres}
```{python}
#| eval: false
...
![Track popularity by gender category](report/images/fig-popularity-gender.png){#fig-popularity-gender}
```{python}
#| eval: false
df_gender = df[df["gender"].isin(["male", "female", "non-binary"])]
...
![Average track popularity across decades](report/images/fig-popularity-across-decades.png){#fig-popularity-across-decades}
```{python}
#| eval: false
...
![Average popularity by gender across decades](report/images/fig-popularity-gender-decade.png){#fig-popularity-gender-decade}
```{python}
#| eval: false
df_clean = df[(df["gender"].isin(["male", "female", "non-binary"])) &
              (df["release_year"] >= 1900)]
...
![Correlation matrix of numeric variables](images/fig-corr-matrix.png){#fig-corr-matrix}
```{python}
#| eval: false
